...
const settings=JSON.parse(fs.readFileSync(`${ROOT}/settings/project.json`,'utf8')); assert.equal(settings['design-resolution-width'],1080); assert.equal(settings['design-resolution-height'],1920);
